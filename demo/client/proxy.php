...
class XmlRpcProxy
{
     ...
     */
    public function __construct(PhpXmlRpc\JsonRpc\Client $client, $prefix = 'examples.', $encodingOptions = array())
    {
        $this->client = $client;
        $this->prefix = $prefix;
    ...
    public function __call($name, $arguments)
    {
        ...
        $resp = $this->client->send(new PhpXmlRpc\JsonRpc\Request($this->prefix.$name, $args));
...
$proxy = new XmlRpcProxy(new PhpXmlRpc\JsonRpc\Client(JSONRPCSERVER));
