<?php
/**
 * JSON-RPC server acting as proxy for requests to other servers
 ...
 * - usage of the PhpXmlRpc\JsonRpc\Encoder class to convert between php values and xml-rpc Value objects
