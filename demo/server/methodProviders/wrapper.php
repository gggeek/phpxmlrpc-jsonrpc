<?php
/**
 * Defines functions and signatures which can be registered as methods exposed by a JSONRPC Server
 *
 * To use this, use something akin to:
 * $signatures = include('wrapper.php');
 * NB: requires 'functions.php' to be included first
 *
 * Wrap methods of json-rpc-unaware php classes and xmlrpc-unaware php functions so that they can be used transparently.
 */
 ...
 * Used to test wrapping of PHP functions into json-rpc methods.
 *
...
class handlersContainer
{
     ...
     * Used to test wrapping of PHP methods into json-rpc methods.
     *
     * @param integer $num
     * @return string
     * @throws Exception
