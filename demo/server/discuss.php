 ...
 * - registration of php class methods as json-rpc method handlers
 * - usage as method handlers of php code which is completely unaware of json-rpc, via the Server's properties
